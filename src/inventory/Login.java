...
public class Login extends Product.FatherClass {
  ...
  if(UserName.equals("")||(UserName.length()>=4&&UserName.length()<8&&UserName.charAt(0)!='@'&&UserName.charAt(0)!='~'&&UserName.charAt(0)!='-'&&UserName.charAt(0)!='+'&&UserName.charAt(0)!='='))
        {
        this.UserName = UserName;
        }
        else 
        {
            System.out.println("Username must be between 4-8 characters and not starting with (@,-,+,=,~) ");
    ...
    public void setPassword(String Password) {//entered passwords must be between 4 and 8 characters
        if(Password.equals("")||(Password.length()>=4&&Password.length()<8&&Password.charAt(0)!='@'&&Password.charAt(0)!='~'&&Password.charAt(0)!='-'&&Password.charAt(0)!='+'&&Password.charAt(0)!='='))
        {
...
public void AddInFileLogin()
{
    ...
    if( !getUserName().equals("")&&!getPassword().trim().equals("")&&!getCase().equals(""))
    {
